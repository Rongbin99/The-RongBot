...
class Slash(commands.Cog):
    ...
    @commands.slash_command(description = "Test the latency of the bot.")
    async def ping(self, ctx):
        await ctx.respond(f'Bong!!! `{round(self.client.latency * 1000, ndigits=2)} ms` :)')

    @commands.slash_command(description = "Check your Valorant Rank")
    ...
    @commands.slash_command(description = "Need help with a calculation?")
    ...
    @commands.slash_command(description = "Resets the value of pets")
    ...
    @commands.slash_command(description = "Perform a unit conversion.")
